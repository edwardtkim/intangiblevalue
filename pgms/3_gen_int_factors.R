...
## FF^INT, EKP method 
  ...
  ret_t100 <- main_rank_t100 %>% 
    ...
    spread(ff_pf, ret_pf) %>% 
    rowwise() %>%
    mutate(high_1 = sum(small_high_1,big_high_1, na.rm=T)/2,
           low_1 = sum(small_low_1,big_low_1, na.rm=T)/2,
           high_2 = sum(small_high_2,big_high_2, na.rm=T)/2,
           low_2 = sum(small_low_2,big_low_2, na.rm=T)/2,
           high_3 = sum(small_high_3,big_high_3, na.rm=T)/2,
           low_3 = sum(small_low_3,big_low_3, na.rm=T)/2,
           high_4 = sum(small_high_4,big_high_4, na.rm=T)/2,
           low_4 = sum(small_low_4,big_low_4, na.rm=T)/2,
           high_5 = sum(small_high_5,big_high_5, na.rm=T)/2,
           low_5 = sum(small_low_5,big_low_5, na.rm=T)/2,
           high_6 = sum(small_high_6,big_high_6, na.rm=T)/2,
           low_6 = sum(small_low_6,big_low_6, na.rm=T)/2,
           high_7 = sum(small_high_7,big_high_7, na.rm=T)/2,
           low_7 = sum(small_low_7,big_low_7, na.rm=T)/2,
           high_8 = sum(small_high_8,big_high_8, na.rm=T)/2,
           low_8 = sum(small_low_8,big_low_8, na.rm=T)/2,
           high_9 = sum(small_high_9,big_high_9, na.rm=T)/2,
           low_9 = sum(small_low_9,big_low_9, na.rm=T)/2,
           high_10 = sum(small_high_10,big_high_10, na.rm=T)/2,
           low_10 = sum(small_low_10,big_low_10, na.rm=T)/2,
           high_11 = sum(small_high_11,big_high_11, na.rm=T)/2,
           low_11 = sum(small_low_11,big_low_11, na.rm=T)/2,
           high_12 = sum(small_high_12,big_high_12, na.rm=T)/2,
           low_12 = sum(small_low_12,big_low_12, na.rm=T)/2,
           hml_1 = high_1 - low_1,
           hml_2 = high_2 - low_2,
           hml_3 = high_3 - low_3,
           hml_4 = high_4 - low_4,
